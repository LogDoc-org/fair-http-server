...
public class Http {
    ...
    private abstract static class Adapter extends WebSocket {
        public Adapter(final Request request) {
            super(request);
        }

        public Adapter(final Request request, final IExtension extension) {
            super(request, extension);
        }

        public Adapter(final Request request, final IExtension extension, final IProtocol protocol) {
            super(request, extension, protocol);
        }
    ...
    public abstract static class JsonSocket extends Adapter {
        public JsonSocket(final Request request) {
            super(request);
        }

        public JsonSocket(final Request request, final IExtension extension) {
            super(request, extension);
        }

        public JsonSocket(final Request request, final IExtension extension, final IProtocol protocol) {
            super(request, extension, protocol);
        }
